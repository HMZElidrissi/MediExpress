...
{
    $sql = "SELECT * FROM sales INNER JOIN medicaments ON sales.medicament_id = medicaments.id WHERE sale_type = 'En Magasin'";
    $stmt = $this->db->query($sql);
    $result = $stmt->fetchAllRecords();
    return $result;
}
public function insert_vente($Namemed , $quantity , $date)
{
