...
<head>
    ...
    <title>Login - Medi Express</title>
                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-flex">
                            <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/pharmacy.jpg&quot;);"></div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method = "POST" action = "Authentification">
                                    ...
                                    </div><button class="btn btn-success d-block btn-user w-100" type="submit" name ="login">Login</button>
